...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="title"]`).type('yowza supposing');
      cy.get(`[data-cy="title"]`).should('have.value', 'yowza supposing');

      cy.get(`[data-cy="description"]`).type('dispense');
      cy.get(`[data-cy="description"]`).should('have.value', 'dispense');
