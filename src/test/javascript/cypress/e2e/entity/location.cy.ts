...
describe('Location e2e test', () => {
  ...
  describe('new Location page', () => {
    ...
    it('should create an instance of Location', () => {
      cy.get(`[data-cy="streetAddress"]`).type('forecast down');
      cy.get(`[data-cy="streetAddress"]`).should('have.value', 'forecast down');

      cy.get(`[data-cy="postalCode"]`).type('focused');
      cy.get(`[data-cy="postalCode"]`).should('have.value', 'focused');

      cy.get(`[data-cy="city"]`).type('Bernardhaven');
      cy.get(`[data-cy="city"]`).should('have.value', 'Bernardhaven');

      cy.get(`[data-cy="stateProvince"]`).type('upbeat energetically knotty');
      cy.get(`[data-cy="stateProvince"]`).should('have.value', 'upbeat energetically knotty');
