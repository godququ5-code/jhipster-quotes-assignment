...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('Legacy Applications Orchestrator');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'Legacy Applications Orchestrator');

      cy.get(`[data-cy="minSalary"]`).type('25945');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '25945');

      cy.get(`[data-cy="maxSalary"]`).type('20455');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '20455');
