...
describe('Department e2e test', () => {
  ...
  let username: string;
  let password: string;
  const departmentSample = { departmentName: 'anxiously what pomelo' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="departmentName"]`).type('disposer');
      cy.get(`[data-cy="departmentName"]`).should('have.value', 'disposer');
