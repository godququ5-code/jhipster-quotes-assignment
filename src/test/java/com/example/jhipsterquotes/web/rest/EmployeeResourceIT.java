...
import static com.example.jhipsterquotes.domain.EmployeeAsserts.*;
import static com.example.jhipsterquotes.web.rest.TestUtil.createUpdateProxyForBean;
...
class EmployeeResourceIT {
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.email(UPDATED_EMAIL).hireDate(UPDATED_HIRE_DATE).salary(UPDATED_SALARY);
