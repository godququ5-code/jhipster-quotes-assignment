...
export const EmployeeDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      ...
      <ModalBody id="jhipsterQuotesApp.employee.delete.question">
        <Translate contentKey="jhipsterQuotesApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
