  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterQuotesApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="jhipsterQuotesApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterQuotesApp.employee.firstName')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterQuotesApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterQuotesApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterQuotesApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterQuotesApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterQuotesApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterQuotesApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('jhipsterQuotesApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('jhipsterQuotesApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
